                    ...
                    For ln As Integer = 0 To lins.Count - 1
                        ...
                        For wd As Integer = 0 To words.Count - 1
                            ...
                            If subwords.Count > 0 Then
                                Dim Varifiedwords = subwords.AsEnumerable.Where(Function(X) X.Length >= UserSettings.MinimumWordLength)
                        ...
                        For wd As Integer = 0 To words.Count - 1
                            ...
                            If subwords.Count > 0 Then
                                For Each wrd In subwords
                                    ...
                                    If Varifiedwords.Length >= UserSettings.MinimumWordLength Then
                    ...
                    If ListOfWord.Count > 0 Then
                        ...
                        If subwords.Count > 0 Then
                            For Each wrd In subwords
                                ...
                                If SequenceOfWord.Length >= UserSettings.MinimumWordLength Then
