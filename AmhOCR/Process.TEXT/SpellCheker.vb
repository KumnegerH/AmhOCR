...
Public Class SpellCheker
    ...
    Public Function isValidWord(ByVal word As String) As Boolean
        ...
        Else
            ...
            If UserSettings.NormalizeChar = True Then
    ...
    ''' <summary>
    ''' Remove language specific white listed characters 
    ''' </summary>
