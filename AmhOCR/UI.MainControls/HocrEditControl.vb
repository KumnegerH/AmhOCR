    ...
    Private Sub SetContextMenuStripHocrOptions()
        ...
        AddHandler ViewsContext.DropDownOpening,
            ...
            Sub(s, e)
                ...
                ElseIf UserSettings.EditMode = ocrEditMode.ParagraphEdit Then
                    BoxsW.Checked = False
                    BoxsL.Checked = False
                    BoxsP.Checked = True
                ...
                If SpellCheker.Loaded = True AndAlso HocrPage.PageOCRsettings.Language = SpellCheker.Lang Then
                    ...
                    If UserSettings.EditMode = ocrEditMode.WordEdit Then
                        ...
                        For parcnt As Integer = 0 To HotHocrObjects.Count - 1 Step 1
                            ...
                            If UserSettings.RemoveWhiteListChar Then
                                parag.text = SpellCheker.RemoveSpecialCharacters(parag.text)
                            End If

                            If UserSettings.NormalizeNumerics Then
    ...
    Private Sub ResetParagraph()
        ...
        Try
            If ContextParaId >= 0 Then
                ...
                If UserSettings.EditMode = ocrEditMode.ParagraphEdit Then
                    HotParagraph.alignment = HotParagraph.HocrObject.Alignment
                    HotParagraph.Font = HotParagraph.HocrObject.Font.Clone
                ElseIf UserSettings.EditMode = ocrEditMode.LineEdit Then

                ElseIf UserSettings.EditMode = ocrEditMode.WordEdit Then
...
#Region "Control Events"
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        ...
        If isBusy = True OrElse HocrPage Is Nothing Then
            Exit Sub
        End If
                ...
                Else
                    ...
                    If HocrHighlighted = True Then
                        ...
                        If State = controlState.None Then
                            ...
                            drawingObject.BoundingBox = HotHocrObjects(SelectedHocrID).HocrObject.bbox
    ...
    ''' <summary>
    ''' Handles rightclick event on hocr object
    ''' </summary>
    ''' <param name="e"></param>
    ...
    ''' <summary>
    ''' Handles Rightclick event on areas other than hocr object
    ''' </summary>
    ''' <param name="e"></param>
    ...
    Private Sub SetResizedBox()
        ...
        If drawingObject.BoundingBox.IsEmpty = False Then

            Dim Highlightarg = New BoundingBoxArg(drawingObject.BoundingBox, _HocrID:=SelectedHocrID)
    ...
    Private Sub SetResizedHocrBox()
        ...
        HotHocr.bbox = drawingObject.BoundingBox
        HotHocr.HocrObject.bbox = drawingObject.BoundingBox

        Dim BlkREC As New Rectangle
        BlkREC = OCRblocks(HotHocr.ParagraphIndex)
        BlkREC = Rectangle.Union(drawingObject.BoundingBox, BlkREC)
            ...
            If drawingObject.type = DrawingType.Rectangle Then
                ...
                If Not drawingObject.BoundingBox.IsEmpty Then
                    ...
                    If MultiSelect = True Then
                        ...
                        If BoxSelectionStPoint.Y > MouseLocation.Y Then
                            FullIntersectionOnly = True
                        End If

                        SetMultiSelect(drawingObject.BoundingBox, FullIntersectionOnly)
    ...
    Protected Overrides Sub OnMouseMove(ByVal e As MouseEventArgs)
        ...
        If isBusy = False Then
            ...
            Else
                ...
                CheckHighlightedObject(MouseLocation)
    ...
    Private Sub OnHocrPaint(ByVal e As PaintEventArgs)
        ...
        Dim userSpellBrush As New Pen(UserSettings.UserSpelledColor, 1)
        Dim errorBrush As New Pen(UserSettings.SpellErrorColor, 1)
...
#End Region
    ...
    Public Property HocrPage As HocrPage
        ...
        Set(value As HocrPage)
            ...
            'UserSettings.MaximumColumn_Num = PostProcessor.ColumnTest_Horizontal(_HocrPage, UserSettings.ColumnRecog_ConfidenceLvl).X
    ...
    Private Sub SetEditBox()
        ...
        Try
            ...
            MouseLocation = ClientToImagePoint(Me.PointToClient(Control.MousePosition))
            CheckHighlightedObject(MouseLocation)
            ...
            If HocrHighlighted Then
                ...
                If (HotParagraph.isLocked = False) AndAlso (String.IsNullOrEmpty(HotParagraph.text) = False) Then
                    ...
                    If UserSettings.EditMode = ocrEditMode.LineEdit OrElse
                        UserSettings.EditMode = ocrEditMode.WordEdit Then
    ...
    Private Sub SetEditerFont(ByVal bbox As Rectangle)
        ...
        Dim fn = New Font(UserSettings.ocrFont.FontFamily, x_size, FontStyle.Regular, GraphicsUnit.Pixel)
