...
Public Class PostProcessor
    ...
    Private Shared Function CheckForFont(ByRef Parabx As HocrPar) As Font
        ...
        UserSettings.SetFont(Parabx.Lang)
        Dim fn As Font = UserSettings.ocrFont.Clone
        ...
        If String.IsNullOrEmpty(Parabx.Text) = False Then
            ...
            fn = New Font(UserSettings.ocrFont.FontFamily, x_size, FontStyle.Regular, GraphicsUnit.Pixel)
